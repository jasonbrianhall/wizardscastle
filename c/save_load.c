...
bool save_game(const char *filename, const Player *player,
  ...
  fprintf(file, "orb_location: %d %d %d;\n", game->orb_location[0],
          game->orb_location[1], game->orb_location[2]);
  fprintf(file, "runestaff_location: %d %d %d;\n", game->runestaff_location[0],
          game->runestaff_location[1], game->runestaff_location[2]);
...
bool load_game(const char *filename, Player *player, GameState *game) {
  ...
  while (fgets(line, sizeof(line), file)) {
    ...
    if (strncmp(line, "location_map:", strlen("location_map:")) == 0) {
      ...
      fprintf(debug_file, "Finished parsing location_map, read %d elements\n",
              MAP_SIZE);
                       ...
                       "discovered_rooms:", strlen("discovered_rooms:")) == 0) {
      ...
      if (sscanf(line + 13, "%d %d %d", &game->orb_location[0],
                 &game->orb_location[1], &game->orb_location[2]) == 3) {
        fprintf(debug_file, "Parsed orb_location: %d %d %d\n",
                game->orb_location[0], game->orb_location[1],
                game->orb_location[2]);
      } else {
        fprintf(debug_file, "Error parsing orb_location\n");
      }
    } else if (strncmp(line, "runestaff_location:",
                       strlen("runestaff_location")) == 0) {
      fprintf(debug_file, "Parsing runestaff_location\n");
      if (sscanf(line + 19, "%d %d %d", &game->runestaff_location[0],
                 &game->runestaff_location[1],
                 &game->runestaff_location[2]) == 3) {
        fprintf(debug_file, "Parsed runestaff_location: %d %d %d\n",
                game->runestaff_location[0], game->runestaff_location[1],
                game->runestaff_location[2]);
      } else {
    ...
    // Handle non-array types
      ...
      if (strcmp(key, "race") == 0)
      ...
      else if (strcmp(key, "temp_strength") == 0)
        player->temp_strength = value;
      else if (strcmp(key, "intelligence") == 0)
        player->intelligence = value;
      else if (strcmp(key, "temp_intelligence") == 0)
        player->temp_intelligence = value;
      else if (strcmp(key, "dexterity") == 0)
        player->dexterity = value;
      else if (strcmp(key, "temp_dexterity") == 0)
        player->temp_dexterity = value;
      else if (strcmp(key, "gold") == 0)
        player->gold = value;
      else if (strcmp(key, "flares") == 0)
        player->flares = value;
      else if (strcmp(key, "armor_type") == 0)
        player->armor_type = value;
      else if (strcmp(key, "armor_points") == 0)
        player->armor_points = value;
      else if (strcmp(key, "weapon_type") == 0)
        player->weapon_type = value;
      else if (strcmp(key, "lamp_flag") == 0)
        player->lamp_flag = value;
        ...
        player->level = value;
      else if (strcmp(key, "runestaff_flag") == 0)
        player->runestaff_flag = value;
      else if (strcmp(key, "orb_flag") == 0)
        player->orb_flag = value;
      else if (strcmp(key, "book_flag") == 0)
        player->book_flag = value;
      else if (strcmp(key, "blindness_flag") == 0)
        player->blindness_flag = value;
      else if (strcmp(key, "stickybook_flag") == 0)
        player->stickybook_flag = value;
      else if (strcmp(key, "has_runestaff") == 0)
        player->has_runestaff = value;
      else if (strcmp(key, "has_orb") == 0)
        player->has_orb = value;
      else if (strcmp(key, "treasure_count") == 0)
        player->treasure_count = value;
      else if (strcmp(key, "web_count") == 0)
        player->web_count = value;
      else if (strcmp(key, "turn_count") == 0)
        game->turn_count = value;
      else if (strcmp(key, "monster_count") == 0)
        game->monster_count = value;
      else if (strcmp(key, "game_over") == 0)
        game->game_over = value;
      else if (strcmp(key, "victory") == 0)
        game->victory = value;
      else if (strcmp(key, "vendor_attacked") == 0)
        game->vendor_attacked = value;
      else
        fprintf(debug_file, "Unknown key: %s\n", key);
    } else {
