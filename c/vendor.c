...
void trade_with_vendor(Player *player, GameState *game)
{
    ...
    while (player->gold >= 10) {
                ...
                if(player->gold>=500)
		{
                    ...
                    {
                        print_message("\n%s, your strength rivals that of the mightiest heroes of legend.\n", player->sex == MALE ? "My liege" : "My lady");                    
                    }
                }
                else
                {
                ...
                if(player->gold>=500)
		{
                    ...
                    {
                        print_message("\n%s, your intellect surpasses even the greatest minds of the realm.\n", player->sex == MALE ? "My liege" : "My lady");
                    }
                }
                else
                {
                ...
                if(player->gold>=500)
		{
                    if (player->dexterity < MAX_DEXTERITY)
                    {
                        ...
                        player->dexterity = get_minimum(player->dexterity + random_number(3) + random_number(3), MAX_DEXTERITY);
                        player->gold -= 500;
                    }
                    else
                    {
